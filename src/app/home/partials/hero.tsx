...
const Hero: React.FC = () => {
  ...
  return (
    <section id='home'>
      <div className='relative mr-auto ml-auto max-w-302'>
        <div className='bg-[url(/images/hero-circle-decoration.png)] bg-[length:40vw_40vw] bg-repeat'>
          <div className='custom-container flex-center relative overflow-hidden bg-[url(/images/hero-grid-decoration.png)] bg-[length:10vw_10vw] bg-[position:-10px_-10px] bg-repeat pt-26 pb-10 md:pt-55.5 md:pb-55'>
            <Image
        ...
        <div className='absolute top-[95%] h-85 w-full bg-[url(/images/waves-background.png)] bg-[length:10vw_10vw] bg-repeat-x md:top-[90%] lg:top-[85%] xl:top-[80%]' />
        <div className='absolute inset-y-0 top-[94%] z-0 h-[12vw] w-[100%] bg-gradient-to-t from-black to-transparent md:top-[90%] lg:top-[85%] xl:top-[77%]' />
      </div>
    </section>
  );
};
