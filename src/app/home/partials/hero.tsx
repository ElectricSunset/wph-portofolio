        ...
        <div className='flex-center relative overflow-hidden bg-[url(/images/background_pattern.png)] bg-contain pt-51.25 pb-63.25'>
          ...
          <div className='flex-center max-w-239.25 flex-col gap-6'>
            ...
            <div className='gradient-pink-purple flex-center rounded-full p-0.5'>
              <p className='text-md-medium rounded-full bg-black px-6 py-2 text-neutral-100'>
                {"🧑 Alex's Portofolio"}
              </p>
            </div>
            <h1 className='text-display-3xl text-center font-extrabold'>
              {'I am a '}
            ...
            <p className='text-md text-center text-neutral-200'>
            ...
            <Button className=''>
              <Link href='#'>{'View Portofolio'}</Link>
            </Button>
          </div>
        </div>
        <Image
          ...
          width={700}
          height={690}
          className='absolute bottom-[-210px] h-auto w-full'
        />
      </div>
    </div>
  );
