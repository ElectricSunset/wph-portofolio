  ...
  return (
    <div className='custom-container mt-20 mb-20'>
      <div className='mb-8 md:mb-12 md:flex'>
        <h2 className='text-display-2xl mb-3 flex-[6.09] basis-80 font-extrabold text-neutral-100 md:mb-0'>
          Experience in Front-End Development
        </h2>
        <p className='text-md font-regular flex-[3.91] basis-80 justify-end text-neutral-200'>
